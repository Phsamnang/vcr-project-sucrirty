package com.kosign.vcrprojectsecurity.config.jwt;
...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails){
        ...
        Map<String,String> extractClaim=new HashMap<>();
        extractClaim.put("roles",userDetails.getAuthorities().toString());
    ...
    public String generateToken(Map<String, String> extractClaim, UserDetails userDetails){
        return Jwts.builder()
